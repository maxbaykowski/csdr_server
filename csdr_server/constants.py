...
DEFAULT_AUDIO_STREAM_WARMUP_TIMEOUT_SECONDS = 0.35
DEFAULT_AUDIO_OUTPUT_FORMAT = "s16"
NARROW_AUDIO_IQ_RATE = 16_000
DEFAULT_AUDIO_OUTPUT_RATE = 48_000
DEFAULT_AUDIO_OUTPUT_CHANNELS = 2
...
SQUELCH_CLOSE_DELAY_SECONDS = 0.03
SQUELCH_OPEN_DELAY_SECONDS = 0.10
